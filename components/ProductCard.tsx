      ...
      <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden border border-gray-100 flex flex-col md:flex-row h-full group">
        <Link href={`/product/${product.id}`} className="flex-1 flex flex-col md:flex-row">
          ...
          <div className="p-4 flex-1 flex flex-col justify-center">
              ...
              <h3 className="font-medium text-gray-800 line-clamp-2 mb-2 leading-5" title={product.name}>
                  {product.name}
              </h3>
        ...
        <div className="p-4 md:w-48 flex items-center justify-center border-t md:border-t-0 md:border-l border-gray-100 bg-gray-50 md:bg-transparent">
          <button 
              onClick={handleAddToCart}
              className="w-full bg-[#E60012] hover:bg-[#cc0010] active:scale-95 transform text-white font-bold py-3 px-4 rounded transition-all flex items-center justify-center gap-2"
          >
